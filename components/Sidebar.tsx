...
export const Sidebar: React.FC<{
  ...
  const NAV_ITEMS: NavItem[] = [
    ...
    { id: 'pur', label: 'Compras', icon: 'fa-cart-arrow-down', roles: [UserRole.MASTER, UserRole.ADMIN, UserRole.FINANCE], path: 'purchases' },
    { id: 'stock', label: 'Stock / Inventário', icon: 'fa-warehouse', roles: [UserRole.MASTER, UserRole.ADMIN, UserRole.FINANCE], path: 'stock' },
